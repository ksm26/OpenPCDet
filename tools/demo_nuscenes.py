...
def parse_config():
    ...
    parser.add_argument('--ckpt', type=str, default='/home/khushdeep/Desktop/OpenPCDet/tools/ckpts/nuscenes/pp_multihead_nds5823_updated.pth', help='specify the pretrained model')
